<template>
  <div>
    <main class="flex bg-slate-300">
      <!-- Left side -->
      <div
        class="lg:w-1/2 w-full py-5 flex flex-col gap-3 justify-between items-center h-screen"
      >
      ...
      <!-- Picture -->
      <div
        class="bg-slate-800 bg-login-image h-screen lg:w-1/2 lg:flex hidden place-items-center justify-center">
        <figure>
          <img src="https://www.sergiorozco.com/images/Target.png" alt="" />
        </figure>
      </div>
    </main>
  </div>
